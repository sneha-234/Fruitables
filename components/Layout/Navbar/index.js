...
import {FaShoppingBag,FaUser,FaMap, FaEnvelope, FaSearch} from "react-icons/fa"
            ...
            <div className="container topbar bg-primary d-none d-lg-block">
                <div className="d-flex justify-content-between">
                    <div className="top-info ps-2">
                        <small className="me-3">< FaMap className="fas fa-map-marker-alt me-2 text-secondary"></FaMap> <Link href="#" className="text-white">123 Street, New York</Link></small>
                        <small className="me-3"><FaEnvelope className="fas fa-envelope me-2 text-secondary"></FaEnvelope><Link href="#" className="text-white">Email@Example.com</Link></small>
                    </div>
                ...
                <nav className="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div className="collapse navbar-collapse bg-white" id="navbarCollapse">
                        ...
                        <div className="d-flex m-3 me-0">
                            <button className="btn-search btn border border-secondary btn-md-square rounded-circle bg-white me-4" data-bs-toggle="modal" data-bs-target="#searchModal"><FaSearch className="fas fa-search text-primary"></FaSearch></button>
